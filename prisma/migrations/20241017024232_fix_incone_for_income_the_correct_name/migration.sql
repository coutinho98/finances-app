/*
  ...
  - The values [INCONE] on the enum `transaction_type` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "transaction_type_new" AS ENUM ('INCOME', 'EXPENSE');
ALTER TABLE "Category" ALTER COLUMN "type" TYPE "transaction_type_new" USING ("type"::text::"transaction_type_new");
